...
1. **Shop Registration**: Mechanic shop owners register by providing business details and selecting their location on an interactive map
2. **Map Visualization**: All registered shops appear as markers on the main map interface
3. **Shop Discovery**: Users can browse the map, click on markers to view shop details
4. **Information Access**: Each shop marker displays services, working hours, contact details, and address
5. **Shop Management**: Registered shop owners can log in to update their information anytime
...
2. **Install dependencies**
   ```bash
   pip install flask flask-pymongo flask-login flask-cors python-dotenv werkzeug
   ```
